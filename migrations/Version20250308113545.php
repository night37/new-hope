 ...
 */
final class Version20250308113545 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE animal (id INT AUTO_INCREMENT NOT NULL, structure_id_id INT NOT NULL, name VARCHAR(100) NOT NULL, gender VARCHAR(255) NOT NULL, age INT NOT NULL, out_department TINYINT(1) NOT NULL, highlight TINYINT(1) NOT NULL, size VARCHAR(255) NOT NULL, color VARCHAR(255) NOT NULL, affinity JSON NOT NULL COMMENT \'(DC2Type:json)\', adoption_status VARCHAR(255) NOT NULL, breed JSON NOT NULL COMMENT \'(DC2Type:json)\', type VARCHAR(255) NOT NULL, picture VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, INDEX IDX_6AAB231FAA95C5C1 (structure_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
