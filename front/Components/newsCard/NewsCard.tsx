...
import { NewsCardProps } from '@/types/card.type';
    ...
    return (
        <article className="container flex">
            ...
            <div className="details-container px-[23px] py-[16px]">
                <h3 className="title-container font-caveat text-large">
                    {' '}
                    {title} <span className="font-handlee text-[8px]">{date}</span>
                </h3>
                <div className="resume-container">
                    <p className="font-handlee text-base">{resume}</p>
                </div>
