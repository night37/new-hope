            ...
            <div className={`container grid grid-cols-12 py-[16.5px]  mx-auto items-center gap-4 ${font.className}` }>
                ...
                <div className="flex lg:col-span-10 col-span-12 lg:flex-row flex-col lg:gap-12">
                    <ul className="w-full color-third flex flex-col">
                        <li className="flex justify-end"><Link href="">TROUVER UN ANIMAL</Link></li>
                        <li className="flex justify-end"><Link href="">TROUVER UNE ASSOCIATION </Link></li>
                        <li className="flex justify-end"><Link href="">QUI SOMMES NOUS ?</Link></li>                    
                    </ul>
                    <ul className="w-full color-third flex flex-col">
                        <li className="flex justify-start"><Link href="">NOUS SOUTENIR</Link></li>
                        <li className="flex justify-start"><Link href="">CONNEXION</Link></li>
                        <li className="flex justify-start"><Link href="">MENTIONS LEGALES</Link></li>
                    </ul>
                </div>
