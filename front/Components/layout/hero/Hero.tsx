...
export function Hero () {
  ...
  return (
    <div className="bg-[url(/hero.png)] bg-no-repeat bg-fit lg:px-[290px] px-[10px] py-[98px] w-full flex justify-center">
      <div className="container bg-white/50 px-[50px] flex flex-col py-[50px] rounded-xl">
          ...
          <div className="form-container container flex grid-cols-12 flex-wrap gap-3 sm:justify-start justify-center">
