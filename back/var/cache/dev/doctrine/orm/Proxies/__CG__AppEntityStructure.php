...
class Structure extends \App\Entity\Structure implements \Doctrine\ORM\Proxy\InternalProxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        "\0".parent::class."\0".'StructureType' => [parent::class, 'StructureType', null, 16],
        "\0".parent::class."\0".'animal' => [parent::class, 'animal', null, 16],
        ...
        'StructureType' => [parent::class, 'StructureType', null, 16],
        'animal' => [parent::class, 'animal', null, 16],
